...
export const ScreenRent = () => {
        ...
        <SafeAreaView style={[styles.container, {backgroundColor: theme === 'dark' ? '#000000' : '#ffffff'}]}>
          ...
          {isLoading ? (
            ...
            <FlatList
              ...
              renderItem={({item}) => (
                <View style={{backgroundColor: theme === 'dark' ? '#000000' : '#ffffff'}}>
                  <TouchableWithoutFeedback
                    onPress={() =>
                      handleNavigate(
                        item?.id,
                    ...
                    }>
                    {
                      ...
                      <View style={[styles.card, {backgroundColor: theme === 'dark' ? '#000000' : '#ffffff'}]}>
                        ...
                        {/*Description*/}
                        <Text style={[styles.cardTextBlack, {color: theme === 'dark' ? '#ffffff' : '#000000'}]}>{item?.title}</Text>
                        ...
                        <Text style={[styles.cardTextBlackPrice, {color: theme === 'dark' ? '#ffffff' : '#000000'}]}>
  ...
  const Header = () => {
    return (
      <View style={[styles.header, {backgroundColor: theme === 'dark' ? '#000000' : '#f9f9f9'}]}>
        <View
          style={{
        ...
        <View style={{alignItems: 'flex-start', width: '40%', padding: 15}}>
          <Text style={{fontSize: 18, color: theme === 'dark' ? '#ffffff' : '#707070'}}>{cityLabelFilter}</Text>
        </View>
          ...
          <Modal visible={isModalVisible} animationType="slide">
            <View
              ...
              <Dropdown
                ...
                placeholderStyle={[styles.placeholderStyle, {color: theme === 'dark' ? '#ffffff' : '#6f6f6f'}]}
                ...
                //dropdownContainerStyle={{ backgroundColor: 'red' }} // Изменение цвета фона выпадающего списка
                itemTextStyle={{ color: theme === 'dark' ? '#6f6f6f' : '#6f6f6f' }} // Изменение цвета текста элементов в выпадающем списке
                /*renderLeftIcon={() => (
              ...
              <Dropdown
                ...
                itemTextStyle={{ color: theme === 'dark' ? '#6f6f6f' : '#6f6f6f' }}
                /*renderLeftIcon={() => (
                  <AntDesign style={styles.icon} color="black" name="Safety" size={20} />
                )}*/
              />
                ...
                <View style={{flex: 1}}>
                  <TextInput
                    ...
                    style={{
                      ...
                      backgroundColor:  theme === 'dark' ? '#f8f9f9' : '#f3f4f6',
                      padding: 5,
                      marginLeft: 10,
                      marginRight: 10,
                      borderRadius: 5,
              ...
              <Dropdown
                style={styles.dropdown}
                placeholderStyle={[styles.placeholderStyle, {color: theme === 'dark' ? '#ffffff' : '#6f6f6f'}]}тзь
                selectedTextStyle={styles.selectedTextStyle}
                inputSearchStyle={styles.inputSearchStyle}
                iconStyle={styles.iconStyle}
